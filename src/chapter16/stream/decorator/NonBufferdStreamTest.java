...
public class NonBufferdStreamTest {
	...
	public static void main(String[] args) {
		...
		{
			//파일복사 작업이 시작하기 전 1970년1월1일 00시00분00초에 현재날짜와시간까지 흐른 누적된시간을 밀리세컨드로 봔환
			milisecond = System.currentTimeMillis();
			
			//파일복사. 입력스트림으로 a.zip파일의 내용을 읽어와서, 출력스트림으로 copy.zip파일을 내용을 쓰는 작업
			int i;
			while((i = fis.read()) != -1 ){
				fos.write(i);
			}
