...
public class ReduceTest {
	...
	public static void main(String[] args) {
		...
		// 위의 String배열을 대상으로 Stream API 작업ㅇ르 할 경우에는 Arrays.stream(String배열)
		
		System.out.println(Arrays.stream(greetings).reduce("", (s1, s2) -> {
			
			/*
			 s1 매계변수에 "" 대입이 되고, s2매개변수 "안녕하세요~~" 대입이 된다.
			 
			 s1의 바이트 길이와 s2의 바이트길이를 if문에서 대소 비교하여, 큰길이의 문자열을 s1에 저장하고
			 s2에는 2번째 문자열("hello")을 대입힌다.
